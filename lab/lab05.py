...
def distance(city_a, city_b):
    ...
    """
    "*** YOUR CODE HERE ***"
    lat_d = get_lat(city_a)-get_lat(city_b)
    lon_d = get_lon(city_a)-get_lon(city_b)
    lat_sqrt = lat_d ** 2
    lon_sqrt = lon_d ** 2
    return sqrt(lon_sqrt + lat_sqrt)
...
def closer_city(lat, lon, city_a, city_b):
    ...
    distance_a = distance(city_a,new_city)
    distance_b = distance(city_b,new_city)
